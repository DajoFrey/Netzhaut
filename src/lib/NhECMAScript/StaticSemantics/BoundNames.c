...
NH_ECMASCRIPT_BEGIN()
    ...
    switch (Node_p->type)
    {
        case NH_ECMASCRIPT_PARSE_NODE_IDENTIFIER :
        {
            ...
            Nh_appendToList(&Result, &((Nh_ECMAScript_ParseNode*)Node_p->Children.pp[0])->Value_p->String);
...
//                        Nh_appendToList(&BindingElementListNames, BindingRestElementNames.pp[i]);
//                    }
...
//                    Nh_appendToList(&FormalParameterListNames, FunctionRestParameterNames.pp[i]);
//                }
...
//                    Nh_appendToList(&Names, FormalParameterNames.pp[i]);
//                }
