...
NH_ENCODING_BEGIN()
    ...
    switch (label)
    {
        ...
        case NH_ENCODING_LABEL_X_UNICODE20UTF8     : name = NH_ENCODING_NAME_UTF8; break;
        ...
        case NH_ENCODING_LABEL_LOGICAL             : name = NH_ENCODING_NAME_ISO_8859_8_L; break;
        ...
        case NH_ENCODING_LABEL_GB18030             : name = NH_ENCODING_NAME_GB1803; break;
...
NH_ENCODING_BEGIN()
    ...
    if (encoding == NH_ENCODING_NAME_REPLACEMENT || encoding == NH_ENCODING_NAME_UTF_16BE || encoding == NH_ENCODING_NAME_UTF_16LE) {
        NH_ENCODING_END(NH_ENCODING_NAME_UTF8)
    }
