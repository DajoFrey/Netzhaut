...
static Nh_WebIDL_ParseResult Nh_WebIDL_parsePrivateInterfaceMember(
    Nh_WebIDL_Parser *Parser_p)
{
NH_WEBIDL_BEGIN()

    if (Parser_p->unparsed > 0 && !strcmp(Parser_p->Tokens_p[0].String.bytes_p, "private"))
    {
        Nh_WebIDL_Parser LocalParser = Nh_WebIDL_advanceParser(*Parser_p, 1);

        Nh_WebIDL_ParseResult PartialInterfaceMember = Nh_WebIDL_parsePartialInterfaceMember(&LocalParser);
        if (PartialInterfaceMember.Node_p != NULL)  
        {
            Nh_WebIDL_ParseNode *PrivateInterfaceMember_p = Nh_WebIDL_allocateNonTerminalParseNode("PrivateInterfaceMember", 2);
            Nh_appendToList(&PrivateInterfaceMember_p->Children, Nh_WebIDL_allocateTerminalParseNode(&Parser_p->Tokens_p[0]));
            Nh_appendToList(&PrivateInterfaceMember_p->Children, PartialInterfaceMember.Node_p);
            *Parser_p = LocalParser;
            NH_WEBIDL_END(Nh_WebIDL_initParseResult(PrivateInterfaceMember_p))
        }
    }
...
NH_WEBIDL_BEGIN()
    ...
    Nh_WebIDL_ParseResult PrivateInterfaceMember = Nh_WebIDL_parsePrivateInterfaceMember(Parser_p);
    if (PrivateInterfaceMember.Node_p != NULL)  
    {
        Nh_WebIDL_ParseNode *InterfaceMember_p = Nh_WebIDL_allocateNonTerminalParseNode("InterfaceMember", 1);
        Nh_appendToList(&InterfaceMember_p->Children, PrivateInterfaceMember.Node_p);
        NH_WEBIDL_END(Nh_WebIDL_initParseResult(InterfaceMember_p))
    }
...
Nh_WebIDL_FinalParseResult Nh_WebIDL_parseFragment(
...
NH_WEBIDL_BEGIN()
    ...
    Nh_WebIDL_FinalParseResult Result;
...
Nh_WebIDL_FinalParseResult Nh_WebIDL_initFinalParseResult()
{
NH_WEBIDL_BEGIN()
