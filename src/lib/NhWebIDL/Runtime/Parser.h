 ...
 */
    ...
    typedef enum NH_WEBIDL_PARSE_NODE {
        ...
        NH_WEBIDL_PARSE_NODE_CALLBACK_OR_INTERFACE_OR_MIXIN,
        NH_WEBIDL_PARSE_NODE_INTERFACE_OR_MIXIN,
        NH_WEBIDL_PARSE_NODE_INTERFACE_REST,
        NH_WEBIDL_PARSE_NODE_PARTIAL,
        NH_WEBIDL_PARSE_NODE_PARTIAL_DEFINITION,
        NH_WEBIDL_PARSE_NODE_PARTIAL_INTERFACE_OR_PARTIAL_MIXIN,
        NH_WEBIDL_PARSE_NODE_PARTIAL_INTERFACE_REST,
        NH_WEBIDL_PARSE_NODE_INTERFACE_MEMBERS,
        NH_WEBIDL_PARSE_NODE_INTERFACE_MEMBER,
        NH_WEBIDL_PARSE_NODE_PARTIAL_INTERFACE_MEMBERS,
        NH_WEBIDL_PARSE_NODE_PARTIAL_INTERFACE_MEMBER,
        ...
        NH_WEBIDL_PARSE_NODE_CALLBACK_REST_OR_INTERFACE,
        NH_WEBIDL_PARSE_NODE_CALLBACK_INTERFACE_MEMBERS,
        NH_WEBIDL_PARSE_NODE_CALLBACK_INTERFACE_MEMBER,
        ...
        NH_WEBIDL_PARSE_NODE_PRIVATE_INTERFACE_MEMBER,
 ...
 */
    ...
    typedef struct Nh_WebIDL_FinalParseResult {
        Nh_WebIDL_ParseNode *Root_p;
        Nh_Array Tokens;
        Nh_List SyntaxErrors;
    } Nh_WebIDL_FinalParseResult;
 ...
 */
    ...
    typedef Nh_WebIDL_FinalParseResult (*Nh_WebIDL_parseFragment_f)(
        NH_BYTE *logName_p, NH_BYTE *fragment_p
    );

    typedef void (*Nh_WebIDL_unparseFragment_f)(
