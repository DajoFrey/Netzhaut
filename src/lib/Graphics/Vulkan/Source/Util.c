...
NH_BEGIN();
    ...
    if (bufferSize <= 0) {NH_DIAGNOSTIC_END(NH_ERROR_PARAMETERS)}
...
NH_BEGIN()
    ...
    if (Driver_p->Func.vkCreatePipelineLayout(Driver_p->Device, PipelineLayoutCreateInfo_p, VK_NULL_HANDLE, &Pipeline_p->PipelineLayout) != VK_SUCCESS) {
        NH_DIAGNOSTIC_END(NH_ERROR_BAD_STATE)
    }
...
NH_BEGIN()
    ...
    switch (result)
    {
         case VK_SUCCESS                                            : NH_DIAGNOSTIC_END(NH_SUCCESS)
         case VK_NOT_READY                                          : NH_DIAGNOSTIC_END(NH_VULKAN_NOT_READY)
         case VK_TIMEOUT                                            : NH_DIAGNOSTIC_END(NH_VULKAN_TIMEOUT)
         case VK_EVENT_SET                                          : NH_DIAGNOSTIC_END(NH_VULKAN_EVENT_SET)
         case VK_EVENT_RESET                                        : NH_DIAGNOSTIC_END(NH_VULKAN_EVENT_RESET)
         case VK_INCOMPLETE                                         : NH_DIAGNOSTIC_END(NH_VULKAN_INCOMPLETE)
         case VK_ERROR_OUT_OF_HOST_MEMORY                           : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_OUT_OF_HOST_MEMORY)
         case VK_ERROR_OUT_OF_DEVICE_MEMORY                         : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_OUT_OF_DEVICE_MEMORY)
         case VK_ERROR_INITIALIZATION_FAILED                        : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INITIALIZATION_FAILED)
         case VK_ERROR_DEVICE_LOST                                  : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_DEVICE_LOST)
         case VK_ERROR_MEMORY_MAP_FAILED                            : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_MEMORY_MAP_FAILED)
         case VK_ERROR_LAYER_NOT_PRESENT                            : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_LAYER_NOT_PRESENT)
         case VK_ERROR_EXTENSION_NOT_PRESENT                        : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_EXTENSION_NOT_PRESENT)
         case VK_ERROR_FEATURE_NOT_PRESENT                          : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_FEATURE_NOT_PRESENT)
         case VK_ERROR_INCOMPATIBLE_DRIVER                          : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INCOMPATIBLE_DRIVER)
         case VK_ERROR_TOO_MANY_OBJECTS                             : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_TOO_MANY_OBJECTS)
         case VK_ERROR_FORMAT_NOT_SUPPORTED                         : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_FORMAT_NOT_SUPPORTED)
         case VK_ERROR_FRAGMENTED_POOL                              : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_FRAGMENTED_POOL)
         case VK_ERROR_UNKNOWN                                      : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_UNKNOWN)
         case VK_ERROR_OUT_OF_POOL_MEMORY                           : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_OUT_OF_POOL_MEMORY)
         case VK_ERROR_INVALID_EXTERNAL_HANDLE                      : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INVALID_EXTERNAL_HANDLE)
         case VK_ERROR_FRAGMENTATION                                : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_FRAGMENTATION)
         case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS               : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS)
         case VK_ERROR_SURFACE_LOST_KHR                             : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_SURFACE_LOST_KHR)
         case VK_ERROR_NATIVE_WINDOW_IN_USE_KHR                     : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_NATIVE_WINDOW_IN_USE_KHR)
         case VK_SUBOPTIMAL_KHR                                     : NH_DIAGNOSTIC_END(NH_VULKAN_SUBOPTIMAL_KHR)
         case VK_ERROR_OUT_OF_DATE_KHR                              : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_OUT_OF_DATE_KHR)
         case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR                     : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INCOMPATIBLE_DISPLAY_KHR)
         case VK_ERROR_VALIDATION_FAILED_EXT                        : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_VALIDATION_FAILED_EXT)
         case VK_ERROR_INVALID_SHADER_NV                            : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INVALID_SHADER_NV)
         case VK_ERROR_INCOMPATIBLE_VERSION_KHR                     : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INCOMPATIBLE_VERSION_KHR)
         case VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT)
         case VK_ERROR_NOT_PERMITTED_EXT                            : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_NOT_PERMITTED_EXT)
         case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT          : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT)
         case VK_THREAD_IDLE_KHR                                    : NH_DIAGNOSTIC_END(NH_VULKAN_THREAD_IDLE_KHR)
         case VK_THREAD_DONE_KHR                                    : NH_DIAGNOSTIC_END(NH_VULKAN_THREAD_DONE_KHR)
         case VK_OPERATION_DEFERRED_KHR                             : NH_DIAGNOSTIC_END(NH_VULKAN_OPERATION_DEFERRED_KHR)
         case VK_OPERATION_NOT_DEFERRED_KHR                         : NH_DIAGNOSTIC_END(NH_VULKAN_OPERATION_NOT_DEFERRED_KHR)
         case VK_PIPELINE_COMPILE_REQUIRED_EXT                      : NH_DIAGNOSTIC_END(NH_VULKAN_PIPELINE_COMPILE_REQUIRED_EXT)
         case VK_RESULT_MAX_ENUM                                    : NH_DIAGNOSTIC_END(NH_VULKAN_RESULT_MAX_ENUM)
         default                                                    : NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_NO_CORRESPONDING_RESULT)
    }
