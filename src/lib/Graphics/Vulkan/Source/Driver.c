...
static NH_RESULT Nh_Vk_validateFunctions(
    Nh_Vk_Driver *Driver_p)
{
NH_BEGIN()

        NH_CHECK_NULL(Driver_p->Func.vkCreateFence)
        NH_CHECK_NULL(Driver_p->Func.vkCreateSemaphore)
        NH_CHECK_NULL(Driver_p->Func.vkAllocateCommandBuffers)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyFence)
        NH_CHECK_NULL(Driver_p->Func.vkDestroySemaphore)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyFramebuffer)
        NH_CHECK_NULL(Driver_p->Func.vkFreeMemory)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyImageView)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyImage)
        NH_CHECK_NULL(Driver_p->Func.vkDestroySwapchainKHR)
        NH_CHECK_NULL(Driver_p->Func.vkCreateSwapchainKHR)
        NH_CHECK_NULL(Driver_p->Func.vkGetSwapchainImagesKHR)
        NH_CHECK_NULL(Driver_p->Func.vkCreateImageView)
        NH_CHECK_NULL(Driver_p->Func.vkCreateImage)
        NH_CHECK_NULL(Driver_p->Func.vkBeginCommandBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkCmdPipelineBarrier)
        NH_CHECK_NULL(Driver_p->Func.vkEndCommandBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkQueueSubmit)
        NH_CHECK_NULL(Driver_p->Func.vkQueueWaitIdle)
        NH_CHECK_NULL(Driver_p->Func.vkFreeCommandBuffers)
        NH_CHECK_NULL(Driver_p->Func.vkCreateFramebuffer)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyDescriptorPool)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyCommandPool)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyRenderPass)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyDevice)
        NH_CHECK_NULL(Driver_p->Func.vkGetDeviceQueue)
        NH_CHECK_NULL(Driver_p->Func.vkCreateDescriptorPool)
        NH_CHECK_NULL(Driver_p->Func.vkCreateCommandPool)
        NH_CHECK_NULL(Driver_p->Func.vkCreateRenderPass)
        NH_CHECK_NULL(Driver_p->Func.vkUpdateDescriptorSets)
        NH_CHECK_NULL(Driver_p->Func.vkCreateBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkFreeMemory)
        NH_CHECK_NULL(Driver_p->Func.vkCreateDescriptorSetLayout)
        NH_CHECK_NULL(Driver_p->Func.vkAllocateDescriptorSets)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyDescriptorSetLayout)
        NH_CHECK_NULL(Driver_p->Func.vkFreeDescriptorSets)
        NH_CHECK_NULL(Driver_p->Func.vkGetImageMemoryRequirements)
        NH_CHECK_NULL(Driver_p->Func.vkGetBufferMemoryRequirements)
        NH_CHECK_NULL(Driver_p->Func.vkAllocateMemory)
        NH_CHECK_NULL(Driver_p->Func.vkBindImageMemory)
        NH_CHECK_NULL(Driver_p->Func.vkBindBufferMemory)
        NH_CHECK_NULL(Driver_p->Func.vkMapMemory)
        NH_CHECK_NULL(Driver_p->Func.vkUnmapMemory)
        NH_CHECK_NULL(Driver_p->Func.vkCreateShaderModule)
        NH_CHECK_NULL(Driver_p->Func.vkCreatePipelineLayout)
        NH_CHECK_NULL(Driver_p->Func.vkCreateGraphicsPipelines)
        NH_CHECK_NULL(Driver_p->Func.vkCreateComputePipelines)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyPipeline)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyPipelineLayout)
        NH_CHECK_NULL(Driver_p->Func.vkAcquireNextImageKHR)
        NH_CHECK_NULL(Driver_p->Func.vkBeginCommandBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkCmdPipelineBarrier)
        NH_CHECK_NULL(Driver_p->Func.vkCmdClearColorImage)
        NH_CHECK_NULL(Driver_p->Func.vkAllocateCommandBuffers)
        NH_CHECK_NULL(Driver_p->Func.vkGetBufferMemoryRequirements)
        NH_CHECK_NULL(Driver_p->Func.vkCmdPipelineBarrier)
        NH_CHECK_NULL(Driver_p->Func.vkCmdCopyBufferToImage)
        NH_CHECK_NULL(Driver_p->Func.vkQueueSubmit)
        NH_CHECK_NULL(Driver_p->Func.vkQueueWaitIdle)
        NH_CHECK_NULL(Driver_p->Func.vkCreateSampler)
        NH_CHECK_NULL(Driver_p->Func.vkCmdBeginRenderPass)
        NH_CHECK_NULL(Driver_p->Func.vkCmdSetViewport)
        NH_CHECK_NULL(Driver_p->Func.vkCmdSetScissor)
        NH_CHECK_NULL(Driver_p->Func.vkCmdClearAttachments)
        NH_CHECK_NULL(Driver_p->Func.vkCmdEndRenderPass)
        NH_CHECK_NULL(Driver_p->Func.vkResetCommandBuffer)
        NH_CHECK_NULL(Driver_p->Func.vkCmdBindPipeline)
        NH_CHECK_NULL(Driver_p->Func.vkCmdBindDescriptorSets)
        NH_CHECK_NULL(Driver_p->Func.vkCmdBindVertexBuffers)
        NH_CHECK_NULL(Driver_p->Func.vkCmdDraw)
        NH_CHECK_NULL(Driver_p->Func.vkDestroyShaderModule)
...
NH_BEGIN()
    ...
    GPU_p->Driver.ComputeCommandPools_p = Nh_allocate(sizeof(VkCommandPool) * NH_MAX_THREADS);
    NH_CHECK_MEM(GPU_p->Driver.ComputeCommandPools_p);
    GPU_p->Driver.GraphicsCommandPools_p = Nh_allocate(sizeof(VkCommandPool) * NH_MAX_THREADS);
...
NH_BEGIN()
    ...
    else {NH_DIAGNOSTIC_END(NH_VULKAN_ERROR_DEVICE_NOT_SUITABLE)}
...
NH_BEGIN()
    ...
    *computeQueue_p  = Nh_Vk_getQueueFamily(Host_p, Driver_p, VK_QUEUE_COMPUTE_BIT);
    ...
    if (*graphicsQueue_p == -1 || *computeQueue_p == -1) {NH_DIAGNOSTIC_END(NH_ERROR_BAD_STATE)}
    ...
    NH_CHECK(Nh_Vk_validateFunctions(Driver_p))
