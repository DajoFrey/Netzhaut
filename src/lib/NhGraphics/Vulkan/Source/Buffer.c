...
NH_BEGIN()
    ...
    int count = Nh_HTML_getBackgroundVertices(Content_p, Node_p, NULL, 10);

    float *vertices_p = Nh_allocate(sizeof(float) * count);
    NH_CHECK_MEM(vertices_p)

    Nh_HTML_getBackgroundVertices(Content_p, Node_p, vertices_p, 10);
...
NH_BEGIN()
    ...
    int count = Nh_HTML_getBackgroundVertices(Content_p, Node_p, vertices_p, 10);
...
NH_BEGIN()
    ...
    float vertices_p[30];
    NH_CHECK(Nh_HTML_getBackgroundImageVertices(Content_p, Node_p, vertices_p, Image_p, 0.001f))
...
NH_BEGIN()
    ...
    switch (type)
    {
        case NH_VK_BUFFER_TOP_BORDER_VERTICES    : count = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, NH_CSS_BORDER_TOP, cornerTriangleCount); break;
        case NH_VK_BUFFER_RIGHT_BORDER_VERTICES  : count = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, NH_CSS_BORDER_RIGHT, cornerTriangleCount); break;
        case NH_VK_BUFFER_BOTTOM_BORDER_VERTICES : count = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, NH_CSS_BORDER_BOTTOM, cornerTriangleCount); break;
        case NH_VK_BUFFER_LEFT_BORDER_VERTICES   : count = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, NH_CSS_BORDER_LEFT, cornerTriangleCount); break;
    }
...
NH_BEGIN()
    ...
    switch (type)
    {
        case NH_VK_BUFFER_TOP_BORDER_VERTICES    : triangleCount = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, 0, cornerTriangleCount); break;
        case NH_VK_BUFFER_RIGHT_BORDER_VERTICES  : triangleCount = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, 1, cornerTriangleCount); break;
        case NH_VK_BUFFER_BOTTOM_BORDER_VERTICES : triangleCount = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, 2, cornerTriangleCount); break;
        case NH_VK_BUFFER_LEFT_BORDER_VERTICES   : triangleCount = Nh_HTML_getBorderVertices(Content_p, Node_p, vertices_p, 3, cornerTriangleCount); break;
    }
...
NH_BEGIN()
    ...
    float vertices_p[30];
    NH_CHECK(Nh_HTML_getImageVertices(Content_p, Node_p, vertices_p, subtractFromZ))
...
NH_BEGIN()
    ...
    for (int i = 0; i < Node_p->Vulkan.Buffers.count; ++i) {
        NH_Vk_Buffer *Buffer_p = Nh_getFromLinkedList(&Node_p->Vulkan.Buffers, i);
        Nh_Vk_destroyBuffer(Driver_p, Buffer_p);
    }

    Nh_destroyLinkedList(&Node_p->Vulkan.Buffers, true);
...
{
NH_BEGIN()
NH_END(Nh_getFromLinkedList(&Node_p->Vulkan.Buffers, index))
}
...
NH_BEGIN()
    ...
    *Data_pp = Nh_allocate(sizeof(NH_Vk_Buffer));
    ...
    Nh_appendToLinkedList(&Node_p->Vulkan.Buffers, *Data_pp);
