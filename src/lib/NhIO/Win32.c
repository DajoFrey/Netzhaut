...
NH_IO_RESULT Nh_Win32_getInput(
...
NH_IO_RESULT Nh_Win32_createWindow(
...
NH_IO_BEGIN()
    ...
    Window_p->type = NH_IO_TYPE_WIN32;
...
NH_IO_RESULT Nh_Win32_destroyWindow(
    Nh_Win32_Window *Window_p)
{
NH_IO_BEGIN()
...
NH_IO_RESULT Nh_Win32_setWindowBackgroundColor(
...
NH_IO_RESULT Nh_Win32_setWindowTitle(
...
NH_IO_RESULT Nh_Win32_setMouseCursor(
