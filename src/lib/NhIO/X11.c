...
NH_IO_RESULT Nh_X11_getInput(
    Nh_X11_Window *Window_p, Nh_IO_Input *Input_p) 
{
NH_IO_BEGIN()
    ...
    while (XPending(Display_p) > 0) 
    {
        ...
        else if (Event.type == ConfigureNotify) 
        {
            ...
            Nh_IO_ConfigureEvent *Event_p = Nh_advanceRingIterator(&Input_p->Configure.Events);
        ...
        else if (Event.type == MotionNotify)
        {
            ...
            Event_p->type       = NH_IO_MOUSE_MOVE;

            Nh_IO_logMouse(Event_p);
        }
        ...
        else if (Event.type == ButtonPress || Event.type == ButtonRelease)
        {
            ...
            {
                case Button1 : button = NH_IO_MOUSE_LEFT; break;
                case Button2 : button = NH_IO_MOUSE_MIDDLE; break;
                case Button3 : button = NH_IO_MOUSE_RIGHT; break;
                case Button4 : button = NH_IO_MOUSE_SCROLL; trigger = NH_IO_TRIGGER_UP; break;
                case Button5 : button = NH_IO_MOUSE_SCROLL; trigger = NH_IO_TRIGGER_DOWN; break;
            }
        ...
        else if (Event.type == KeyPress || Event.type == KeyRelease)
        {
            ...
            NH_IO_TRIGGER event = Event.type == KeyPress ? NH_IO_TRIGGER_PRESS : NH_IO_TRIGGER_RELEASE;
            NH_IO_KEY key = 0;
            ...
            Input_p->Keyboard.state_p[key] = event == NH_IO_TRIGGER_PRESS;
        }
...
NH_IO_DIAGNOSTIC_END(NH_IO_ERROR_BAD_STATE)
}

// WINDOW ==========================================================================================

NH_IO_RESULT Nh_X11_createWindow(
...
NH_IO_RESULT Nh_X11_destroyWindow(
...
NH_IO_RESULT Nh_X11_setWindowBackgroundColor(
...
NH_IO_RESULT Nh_X11_setWindowTitle(
...
NH_IO_RESULT Nh_X11_setMouseCursor(
...
NH_IO_BEGIN()
    ...
    switch (type)
    {
        case NH_IO_MOUSE_CURSOR_DEFAULT : C = XcursorLibraryLoadCursor(Window_p->Display_p, "arrow"); break;
        case NH_IO_MOUSE_CURSOR_TEXT    : C = XcursorLibraryLoadCursor(Window_p->Display_p, "xterm"); break;
    }
