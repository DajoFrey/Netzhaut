...
NH_INSTALLER_BEGIN()
    ...
    CREATE("NhCore/BigInt.c", "../../lib/OBJECTS/CORE/BigInt.o", extra_p)
...
NH_INSTALLER_BEGIN()
    ...
    CREATE("NhHTML/Parser/TreeConstructionHelper.c", "../../lib/OBJECTS/HTML/TreeConstructionHelper.o", extra_p)
    CREATE("NhHTML/Objects/Document.c", "../../lib/OBJECTS/HTML/Document.o", extra_p)
    CREATE("NhHTML/Common/Log.c", "../../lib/OBJECTS/HTML/Log.o", extra_p)
...
static void *Nh_Installer_createNhDOMObjects(
    void *extra_p)
{
NH_INSTALLER_BEGIN()

    CREATE("NhDOM/NodeList.c", "../../lib/OBJECTS/DOM/NodeList.o", extra_p)
    ...
    CREATE("NhDOM/Text.c", "../../lib/OBJECTS/DOM/Text.o", extra_p)
...
static NH_INSTALLER_RESULT Nh_Installer_createNhDOMObjectsDir(
    char *projDir_p, char *path_p)
{
NH_INSTALLER_BEGIN()

    chdir(projDir_p);
    NH_INSTALLER_CHECK(NH_INSTALLER_ERROR_CANT_CREATE_BIN_OBJECT_DIRECTORY, Nh_Installer_createDir("lib/OBJECTS/DOM"))
    chdir(path_p);
    ...
    NH_INSTALLER_CHECK(NH_INSTALLER_ERROR_CANT_CREATE_OBJECTS, (NH_INSTALLER_RESULT)Nh_Installer_createNhDOMObjects(extra_p))
...
NH_INSTALLER_BEGIN()
    ...
    if (!strcmp(name_p, "Netzhaut")) {
        ...
        NH_INSTALLER_CHECK(NH_INSTALLER_ERROR_BUILD_LIBRARY_FAILED, Nh_Installer_createNhDOMObjectsDir(projDir_p, path_p))
    }
