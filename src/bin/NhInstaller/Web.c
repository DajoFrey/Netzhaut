...
static NH_BYTE *files_pp[] = {
    "src/lib/NhWeb/Specs/DOM/TreeWalker.web",
    "src/lib/NhWeb/Specs/DOM/Text.web",
    "src/lib/NhWeb/Specs/DOM/StaticRange.web",
    "src/lib/NhWeb/Specs/DOM/Slottable.web",
    "src/lib/NhWeb/Specs/DOM/ShadowRoot.web",
    "src/lib/NhWeb/Specs/DOM/Range.web",
    "src/lib/NhWeb/Specs/DOM/ProcessingInstruction.web",
    "src/lib/NhWeb/Specs/DOM/ParentNode.web",
    "src/lib/NhWeb/Specs/DOM/NonElementParentNode.web",
    "src/lib/NhWeb/Specs/DOM/NonDocumentTypeChildNode.web",
    "src/lib/NhWeb/Specs/DOM/NodeList.web",
    "src/lib/NhWeb/Specs/DOM/NodeIterator.web",
    "src/lib/NhWeb/Specs/DOM/NodeFilter.web",
    "src/lib/NhWeb/Specs/DOM/Node.web",
    "src/lib/NhWeb/Specs/DOM/NamedNodeMap.web",
    "src/lib/NhWeb/Specs/DOM/MutationRecord.web",
    "src/lib/NhWeb/Specs/DOM/MutationObserver.web",
    "src/lib/NhWeb/Specs/DOM/HTMLCollection.web",
    "src/lib/NhWeb/Specs/DOM/EventTarget.web",
    "src/lib/NhWeb/Specs/DOM/Event.web",
    "src/lib/NhWeb/Specs/DOM/Element.web",
    "src/lib/NhWeb/Specs/DOM/DocumentType.web",
    "src/lib/NhWeb/Specs/DOM/DocumentOrShadowRoot.web",
    "src/lib/NhWeb/Specs/DOM/DocumentFragment.web",
    "src/lib/NhWeb/Specs/DOM/Document.web",
    "src/lib/NhWeb/Specs/DOM/DOMTokenList.web",
    "src/lib/NhWeb/Specs/DOM/DOMImplementation.web",
    "src/lib/NhWeb/Specs/DOM/Comment.web",
    "src/lib/NhWeb/Specs/DOM/ChildNode.web",
    "src/lib/NhWeb/Specs/DOM/CharacterData.web",
    "src/lib/NhWeb/Specs/DOM/CDataSection.web",
    "src/lib/NhWeb/Specs/DOM/Attr.web",
    "src/lib/NhWeb/Specs/DOM/AbstractRange.web",
    "src/lib/NhWeb/Specs/DOM/AbortSignal.web",
    "src/lib/NhWeb/Specs/DOM/AbortController.web",
    "src/lib/NhWeb/Specs/HTML/Document.web",
    "src/lib/NhWeb/Specs/HTML/DocumentOrShadowRoot.web",
    "src/lib/NhWeb/Specs/HTML/HTMLElement.web",
    "src/lib/NhWeb/Specs/HTML/HTMLOrSVGElement.web",
};
...
NH_INSTALLER_BEGIN()
    ...
    while (*filepath_p != '/') {filepath_p = filepath_p - 1;}
    filepath_p = filepath_p + 1;
    for (int i = 0; strcmp(filepath_p, ".web"); ++i) {fragmentname_p[i] = *filepath_p; filepath_p = filepath_p + 1;}
...
//    sprintf(str_p + strlen(str_p), "%s.web.c", tmp_p);
//
//    NH_BYTE *buffer_p = 0;
//    long length;
//
...
NH_INSTALLER_BEGIN()
    ...
    for (int i = 0; i < fileCount; ++i) 
    {
        ...
        fprintf(f,"#include \"../Specs/%s.web.h\"\n", fragmentName_p);
    }
...
NH_INSTALLER_BEGIN()
    ...
    if (mode == 0) {
        fprintf(f, "\n// FRAGMENT NAMES ==================================================================================\n\n");
        fprintf(f, "NH_BYTE *NH_WEB_FRAGMENT_NAMES_PP[] = {\n");
    }
    else if (mode == 1) {
        fprintf(f, "\n// FRAGMENTS =======================================================================================\n\n");
        fprintf(f, "unsigned NH_BYTE *NH_WEB_FRAGMENTS_PP[] = {\n");
    }
    else if (mode == 2) {
        fprintf(f, "\n// FRAGMENT LENGTHS =================================================================================\n\n");
        fprintf(f, "const unsigned int NH_WEB_FRAGMENT_LENGTHS_P[] = {\n");
    }
    ...
    for (int i = 0; i < fileCount; ++i) 
    {
        ...
        if (mode == 0) {
            ...
            fprintf(f, "    Nh_Web_%s_p,\n", fragmentName_p);
        }
        else if (mode == 2) {
            fprintf(f, "    Nh_Web_%s_p_len,\n", fragmentName_p);
        }
    }
...
NH_INSTALLER_BEGIN()
    ...
    sprintf(name_p, "Nh_Web_%s", fragmentName_p);

    NH_BYTE command_p[1024] = {'\0'};
    sprintf(command_p, "./bin/external/xxd -i %s %s.h Nh_Web_%s_p", filePath_p, filePath_p, fragmentName_p);
...
static NH_INSTALLER_RESULT Nh_Installer_processWebFragment(
...
//    NH_INSTALLER_CHECK(Nh_Installer_generateOperationsFile(fragmentName_p, operationsOut_p, &totalOperations_pp[totalOperationCount - count], count))
    ...
    NH_INSTALLER_CHECK(Nh_Installer_createIncludeFile("src/lib/NhWeb/Runtime"))

NH_INSTALLER_DIAGNOSTIC_END(NH_INSTALLER_SUCCESS)
}

NH_INSTALLER_RESULT Nh_Installer_processWebSpecs()
{
NH_INSTALLER_BEGIN()

    for (int i = 0; i < 34; ++i) {
        NH_INSTALLER_CHECK(Nh_Installer_processWebFragment("src/lib/NhDOM/Interfaces", files_pp[i]))
    }
    for (int i = 34; i < 39; ++i) {
        NH_INSTALLER_CHECK(Nh_Installer_processWebFragment("src/lib/NhHTML/Interfaces", files_pp[i]))
    }
